...
\author{李庆岩}
\title{SUSTCH Beamer Theme}
\subtitle{毕业设计开题报告}
\institute{南方科技大学XXXX系}
\date{2023年4月15日}
\usepackage{SUSTCH}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.3\linewidth]{pic/sustch_logo.png}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{作图}
    ...
    \begin{figure}[htpb]
        \centering
        \includegraphics[width=0.2\linewidth]{pic/sustch_logo.png}
        \caption{这个校徽就是不是矢量图，虽然看起来不像，但确实不是矢量图格式}
    \end{figure}
\end{frame}
